...
import myImage from '../assets/sam.jpeg';
          ...
          <Grid item xs={12} md={4}>
            <Box display="flex" flexDirection="column" alignItems="center">
              <motion.div initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, delay: 0.5 }}>
                <Box component="img" src={image1} alt="Image 1" sx={{ width: 150, height: 150, borderRadius: 2, boxShadow: 3, transform: 'rotate(-5deg)' }} />
              </motion.div>
              <motion.div initial={{ x: 50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, delay: 0.7 }}>
                <Box component="img" src={image2} alt="Image 2" sx={{ width: 150, height: 150, borderRadius: 2, boxShadow: 3, transform: 'rotate(5deg)', mt: 2 }} />
              </motion.div>
